        ...
        if reader.ReadBoolean():
            ...
            for _ in range(mintmark_count):
                ...
                if reader.ReadBoolean():
                    ...
                    base_attri_value_list = [reader.ReadSignedInt() for _ in range(base_count)]
                ...
                if reader.ReadBoolean():
                    ...
                    extra_attri_value_list = [reader.ReadSignedInt() for _ in range(extra_count)]
                ...
                if reader.ReadBoolean():
                    ...
                    max_attri_value_list = [reader.ReadSignedInt() for _ in range(max_attri_count)]
                ...
                if reader.ReadBoolean():
                    ...
                    monster_id_list = [reader.ReadSignedInt() for _ in range(monster_count)]
